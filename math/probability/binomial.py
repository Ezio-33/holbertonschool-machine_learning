...
class Binomial:
    ...
    def __init__(self, data=None, n=1, p=0.5):
        ...
        Args:
            data (list, optional): Liste de données
            pour estimer la distribution
        ...
        if data is None:
            ...
            # Si des données sont fournies, calculer n et p
            ...
            # Pour une distribution binomiale, on a:
            # mean = n*p et variance = n*p*(1-p)
            ...
            # Recalculer p à partir de n et de la moyenne
    ...
    def pmf(self, k):
        ...
        # C(n,k) = n! / (k! × (n-k)!)
        # Pour éviter des calculs de factorielles très grands,
        # on calcule directement en multipliant/divisant de manière itérative
