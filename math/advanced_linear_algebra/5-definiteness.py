...
def definiteness(matrix):
    ...
    Args:
        matrix (numpy.ndarray): Matrice dont le caractère défini doit être calculé.
    
    Returns:
        str: "Positive definite", "Positive semi-definite", "Negative semi-definite",
             "Negative definite", ou "Indefinite" selon le caractère de la matrice.
             None si la matrice n'est pas valide ou ne correspond à aucune catégorie.
