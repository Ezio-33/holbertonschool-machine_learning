#!/usr/bin/env python3
"""Module de calcul de probabilité marginale bayésienne"""
import numpy as np

def marginal(x, n, P, Pr):
    """
    Calcule la probabilité marginale des données observées
    ...
    Returns:
        float: Probabilité marginale (somme des intersections)
    """
    # Vérification des erreurs (identique à la Tâche 1)
    ...
    # Calcul final : somme des intersections
    return np.sum(results * Pr)
