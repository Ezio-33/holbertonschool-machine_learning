#!/usr/bin/env python3
"""
Module WGAN_clip - Implémentation d'un WGAN avec poids clipsés
"""
...
class WGAN_clip(keras.Model):
    ...
    Args:
        ...
        discriminator: Modèle discriminateur (appelé 'critic' dans WGAN)
        latent_generator: Fonction générant des vecteurs latents
    ...
    def __init__(
        ...
        # Définition des fonctions de perte WGAN
        # Le générateur veut maximiser la sortie
    ...
    def get_fake_sample(self, size=None, training=False):
        """Génère un batch de données fausses"""
    ...
    def train_step(self, data):
        ...
        # 1. Entraînement du discriminateur (critic)
